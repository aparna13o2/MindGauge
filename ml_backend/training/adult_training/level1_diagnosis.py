# train_adult_level1_diagnosis.py
import sys
import os
import joblib
import pandas as pd
...
if __name__ == '__main__':
    ...
    # --- 1. Define Paths and Configuration for the ADULT LEVEL 1 DIAGNOSIS ---
    ...
    # Define the 13 domain features (X)
    FEATURE_COLUMNS = [
    ...
    print("Starting Adult Level 1 Diagnosis Model Training...")
    ...
    try:
        ...
        print("\nSuccessfully trained and saved the Adult Level 1 Diagnosis model!")
